...
public class MainUI extends JPanel implements ActionListener {
	...
	JFileChooser fc;
	File file;
	PdfActions actions = new PdfActions();
	...
	public MainUI() {
		...
		// Graphics Repository (but we extracted it from the jar).
		saveButton = new JButton("Split document...", createImageIcon("images/Save16.gif"));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == openButton) {
			...
			try {
				actions.splitDocument(file);
				log.append("Saved: " + file.getName() + "." + newline);
			} catch (Exception e2) {
				log.append("Error: " + e2.toString() + "." + newline);
			}
			log.setCaretPosition(log.getDocument().getLength());
		}
	}
